...
public class Credit extends JFrame {
	...
	public Credit() {
		...
		c.add(Need1);
		Need1.setBounds(70, 85, 250, 40);
		
		go1 = new JLabel("교양필수");
		go1.setFont(new Font("휴먼고딕체",Font.BOLD,22));
		c.add(go1);
		go1.setBounds(70, 140, 100, 40);
		...
		c.add(gi1);
		gi1.setBounds(250, 140, 100, 40);
		
		gi2 = new JLabel("기본선택");
		gi2.setFont(new Font("휴먼고딕체",Font.BOLD,22));
		c.add(gi2);
		gi2.setBounds(240, 140, 100, 150);
		
		jun1 = new JLabel("전공필수");
		jun1.setFont(new Font("휴먼고딕체",Font.BOLD,22));
		c.add(jun1);
		jun1.setBounds(430, 140, 100, 40);
		
		jun2 = new JLabel("전공선택");
		jun2.setFont(new Font("휴먼고딕체",Font.BOLD,22));
		c.add(jun2);
		jun2.setBounds(385, 140, 100, 150);
		
	    hak1 = new JLabel("총 이수학점");
		hak1.setFont(new Font("휴면고딕체",Font.BOLD,22));
		c.add(hak1);
		hak1.setBounds(75, 85, 250, 365);
		
		Need2 = new JLabel("필요학점");
		Need2.setFont(new Font("휴면고딕체",Font.BOLD,40));
		c.add(Need2);
		Need2.setBounds(30, 110, 250, 470);
		
		go3 = new JLabel("교양필수");
		go3.setFont(new Font("휴먼고딕체",Font.BOLD,17));
		c.add(go3);
		go3.setBounds(30, 165, 100, 460);
		
		go4 = new JLabel("교양선택");
		go4.setFont(new Font("휴먼고딕체",Font.BOLD,17));
		c.add(go4);
		go4.setBounds(30, 165, 100, 570);
		
		gi3 = new JLabel("기본필수");
		gi3.setFont(new Font("휴먼고딕체",Font.BOLD,17));
		c.add(gi3);
		gi3.setBounds(175, 165, 100, 460);
		
		gi4 = new JLabel("기본선택");
		gi4.setFont(new Font("휴먼고딕체",Font.BOLD,17));
		c.add(gi4);
		gi4.setBounds(175, 165, 100, 570);
		
		jun3 = new JLabel("전공필수");
		jun3.setFont(new Font("휴먼고딕체",Font.BOLD,17));
		c.add(jun3);
		jun3.setBounds(320, 165, 100, 460);
		
		jun4 = new JLabel("전공선택");
		jun4.setFont(new Font("휴먼고딕체",Font.BOLD,17));
		c.add(jun4);
		jun4.setBounds(320, 165, 100, 570);
		
		hak2 = new JLabel("총 이수학점");
		hak2.setFont(new Font("휴면고딕체",Font.BOLD,17));
		c.add(hak2);
		hak2.setBounds(5, 110, 250, 780);
		
		box1 = new JTextField();
		c.add(box1);
		box1.setBounds(165, 145, 70, 30);
		
		box2 = new JTextField();
		c.add(box2);
		box2.setBounds(345, 145, 70, 30);
		
		box3 = new JTextField();
		c.add(box3);
		box3.setBounds(480, 145, 70, 30);
		
		box4 = new JTextField();
		c.add(box4);
		box4.setBounds(165, 205, 70, 30);
		
		box5 = new JTextField();
		c.add(box5);
		box5.setBounds(310, 205, 70, 30);
		
		box6 = new JTextField();
		c.add(box6);
		box6.setBounds(455, 205, 70, 30);
		
		box7 = new JTextField();
		c.add(box7);
		box7.setBounds(165, 255, 70, 30);
		
		box8 = new JTextField();
		c.add(box8);
		box8.setBounds(105, 380, 70, 30);
		box8.setEditable(false);
		
		box9 = new JTextField();
		c.add(box9);
		box9.setBounds(250, 380, 70, 30);
		box9.setEditable(false);
		
		box10 = new JTextField();
		c.add(box10);
		box10.setBounds(395, 380, 70, 30);
		box10.setEditable(false);
		
		box11 = new JTextField();
		c.add(box11);
		box11.setBounds(105, 435, 70, 30);
		box11.setEditable(false);
		
		box12 = new JTextField();
		c.add(box12);
		box12.setBounds(250, 435, 70, 30);
		box12.setEditable(false);
		
		box13 = new JTextField();
		c.add(box13);
		box13.setBounds(395, 435, 70, 30);
		box13.setEditable(false);
		
		box14 = new JTextField();
		c.add(box14);
		box14.setBounds(105, 485, 70, 30);
